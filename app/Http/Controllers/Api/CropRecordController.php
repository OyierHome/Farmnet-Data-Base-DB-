...
class CropRecordController extends Controller
{
    ...
    public function create_revenue_record(Request $request)
    {
        ...
        $record->advertisement_qty = $request->advertisement_qty;
        $record->advertisement_price = $request->advertisement_price;
        ...
        $record->royalty_qty = $request->royalty_qty;
        $record->royalty_price = $request->royalty_price;
        ...
        $record->training_qty = $request->training_qty;
        $record->training_price = $request->training_price;
